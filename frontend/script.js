...
//--------------------------------------------------
// BUSCAR CEP VIA VIACEP (para o cadastro)
//--------------------------------------------------
...
async function cadastrar() {
  ...
  try {
    ...
    // Limpar formulário
    ['nome', 'sobrenome', 'email', 'celular', 'cep', 'casa', 'cpf', 'rua', 'cidade'].forEach(id => {
    ...
    if (ctxEconomia) {
      graficoEconomia = new Chart(ctxEconomia, {
        ...
        data: {
          ...
          datasets: [{ data: [economiaPerc, 100 - economiaPerc], backgroundColor: ['rgba(62,207,142,0.85)', 'rgba(255,255,255,0.06)'],
            borderColor: [
                        'rgba(62, 207, 142, 1)',
...
//--------------------------------------------------
// LISTAR COM PAGINAÇÃO (exibe endereço completo)
//--------------------------------------------------
